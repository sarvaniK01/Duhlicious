...
const HeroElement = ({hBg, hImage, hTitle, hDescription}) => {
    return (
        <section className={`${hBg} bg-no-repeat bg-cover h-screen`}>
            <div className="container absolute my-20 top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 mx-auto px-6 md:px-12 lg:px-16 xl:px-24 flex flex-col flex-col-reverse md:flex-row justify-between gap-y-10 md:gap-y-0 md:gap-x-10 lg:gap-x-20 z-1">
